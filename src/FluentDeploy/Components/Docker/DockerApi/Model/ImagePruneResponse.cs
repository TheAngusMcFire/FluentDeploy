...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ImagePruneResponse : IEquatable<ImagePruneResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ImagePruneResponse(List<ImageDeleteResponseItem> imagesDeleted = default, long spaceReclaimed = default)
        {
        ...
        /// <summary>
        ///     Returns true if ImagePruneResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ImagePruneResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImagePruneResponse input)
        {
            if (input == null)
                return false;
            ...
            return
                (
                    ImagesDeleted == input.ImagesDeleted ||
                    ImagesDeleted != null &&
                    input.ImagesDeleted != null &&
                    ImagesDeleted.SequenceEqual(input.ImagesDeleted)
                ) &&
                (
        ...
        {
            return Equals(input as ImagePruneResponse);
        }
