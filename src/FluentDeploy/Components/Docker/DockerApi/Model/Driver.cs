...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class Driver : IEquatable<Driver>, IValidatableObject
    {
        /// <summary>
        ...
        ///     Initializes a new instance of the <see cref="Driver" /> class.
        /// </summary>
        /// <param name="name">Name of the driver. (required).</param>
        /// <param name="options">Key/value map of driver-specific options..</param>
        public Driver(string name = default, Dictionary<string, string> options = default)
        {
