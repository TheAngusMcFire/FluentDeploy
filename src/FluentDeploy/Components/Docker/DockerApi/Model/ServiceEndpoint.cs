...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ServiceEndpoint : IEquatable<ServiceEndpoint>, IValidatableObject
    {
        /// <summary>
        ...
        public ServiceEndpoint(EndpointSpec spec = default, List<EndpointPortConfig> ports = default,
            List<ServiceEndpointVirtualIPs> virtualIPs = default)
        {
            Spec = spec;
            Ports = ports;
        ...
        public List<ServiceEndpointVirtualIPs> VirtualIPs { get; set; }

        /// <summary>
        ///     Returns true if ServiceEndpoint instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceEndpoint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceEndpoint input)
        {
            if (input == null)
                return false;
            ...
            return
                ...
                (
                    ...
                    VirtualIPs != null &&
                    input.VirtualIPs != null &&
                    VirtualIPs.SequenceEqual(input.VirtualIPs)
                );
        }
        ...
        {
            return Equals(input as ServiceEndpoint);
        }
