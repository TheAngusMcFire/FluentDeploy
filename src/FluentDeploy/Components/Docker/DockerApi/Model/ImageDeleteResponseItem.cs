...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ImageDeleteResponseItem : IEquatable<ImageDeleteResponseItem>, IValidatableObject
    {
        /// <summary>
        ...
        public ImageDeleteResponseItem(string untagged = default, string deleted = default)
        {
            Untagged = untagged;
            Deleted = deleted;
        }
        ...
        /// </summary>
        /// <param name="input">Instance of ImageDeleteResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageDeleteResponseItem input)
        {
            if (input == null)
                return false;
            ...
            return
                (
                    ...
                    Untagged != null &&
                    Untagged.Equals(input.Untagged)
                ) &&
                (
        ...
        {
            return Equals(input as ImageDeleteResponseItem);
        }
