...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class InlineObject : IEquatable<InlineObject>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineObject(string name = default, string description = default, List<string> value = default)
        {
            Name = name;
