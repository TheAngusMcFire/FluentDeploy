...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class EndpointIPAMConfig : IEquatable<EndpointIPAMConfig>, IValidatableObject
    {
        /// <summary>
        ...
        public EndpointIPAMConfig(string iPv4Address = default, string iPv6Address = default,
            List<string> linkLocalIPs = default)
        {
        ...
        public bool Equals(EndpointIPAMConfig input)
        {
            ...
            return
                ...
                (
                    LinkLocalIPs == input.LinkLocalIPs ||
                    LinkLocalIPs != null &&
                    input.LinkLocalIPs != null &&
                    LinkLocalIPs.SequenceEqual(input.LinkLocalIPs)
                );
        }
        ...
        {
            return Equals(input as EndpointIPAMConfig);
        }
