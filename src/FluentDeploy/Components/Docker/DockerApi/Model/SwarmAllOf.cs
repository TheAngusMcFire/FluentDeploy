...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class SwarmAllOf : IEquatable<SwarmAllOf>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="SwarmAllOf" /> class.
        /// </summary>
        /// <param name="joinTokens">joinTokens.</param>
        public SwarmAllOf(JoinTokens joinTokens = default)
        {
        ...
        /// <summary>
        ///     Returns true if SwarmAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SwarmAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwarmAllOf input)
        {
            if (input == null)
                return false;
        ...
        {
            return Equals(input as SwarmAllOf);
        }
