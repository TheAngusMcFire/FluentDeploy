...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class Config : IEquatable<Config>, IValidatableObject
    {
        /// <summary>
        ...
        public Config(string iD = default, ObjectVersion version = default, string createdAt = default,
            string updatedAt = default, ConfigSpec spec = default)
        {
            ID = iD;
            _Version = version;
            CreatedAt = createdAt;
