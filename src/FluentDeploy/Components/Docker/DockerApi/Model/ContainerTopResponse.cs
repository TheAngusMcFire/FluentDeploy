...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ContainerTopResponse : IEquatable<ContainerTopResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </param>
        public ContainerTopResponse(List<string> titles = default, List<List<string>> processes = default)
        {
            Titles = titles;
            Processes = processes;
        }
        ...
        /// <summary>
        ///     Returns true if ContainerTopResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ContainerTopResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContainerTopResponse input)
        {
            if (input == null)
                return false;
            ...
            return
                (
                    ...
                    Titles != null &&
                    input.Titles != null &&
                    Titles.SequenceEqual(input.Titles)
                ) &&
                (
                    Processes == input.Processes ||
                    Processes != null &&
                    input.Processes != null &&
                    Processes.SequenceEqual(input.Processes)
                );
        }
        ...
        {
            return Equals(input as ContainerTopResponse);
        }
