...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class MountTmpfsOptions : IEquatable<MountTmpfsOptions>, IValidatableObject
    {
        /// <summary>
        ...
        public MountTmpfsOptions(long sizeBytes = default, int mode = default)
        {
            SizeBytes = sizeBytes;
            Mode = mode;
        }
        ...
        /// </summary>
        /// <param name="input">Instance of MountTmpfsOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MountTmpfsOptions input)
        {
            if (input == null)
                return false;
            ...
            return
                (
                    ...
                    SizeBytes != null &&
                    SizeBytes.Equals(input.SizeBytes)
                ) &&
                (
                    Mode == input.Mode ||
                    Mode != null &&
        ...
        {
            return Equals(input as MountTmpfsOptions);
        }
