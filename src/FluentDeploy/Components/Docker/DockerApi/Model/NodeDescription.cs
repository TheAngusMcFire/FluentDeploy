...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class NodeDescription : IEquatable<NodeDescription>, IValidatableObject
    {
        /// <summary>
        ...
        public NodeDescription(string hostname = default, Platform platform = default,
            ResourceObject resources = default, EngineDescription engine = default, TLSInfo tLSInfo = default)
        {
            Hostname = hostname;
            Platform = platform;
            Resources = resources;
        ...
        /// </summary>
        /// <param name="input">Instance of NodeDescription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NodeDescription input)
        {
            if (input == null)
                return false;
        ...
        {
            return Equals(input as NodeDescription);
        }
