...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class BuildInfo : IEquatable<BuildInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public BuildInfo(string id = default, string stream = default, string error = default,
            ErrorDetail errorDetail = default, string status = default, string progress = default,
            ProgressDetail progressDetail = default, ImageID aux = default)
        {
            Id = id;
            Stream = stream;
            Error = error;
        ...
        public bool Equals(BuildInfo input)
        {
            ...
            return
                ...
                (
                    ...
                    ErrorDetail != null &&
                    ErrorDetail.Equals(input.ErrorDetail)
                ) &&
                (
                    Status == input.Status ||
                    Status != null &&
        ...
        {
            return Equals(input as BuildInfo);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (Aux != null)
                    hashCode = hashCode * 59 + Aux.GetHashCode();
                return hashCode;
            }
        }
    }
