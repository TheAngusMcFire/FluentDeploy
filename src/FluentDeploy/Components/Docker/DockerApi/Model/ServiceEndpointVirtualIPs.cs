...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ServiceEndpointVirtualIPs : IEquatable<ServiceEndpointVirtualIPs>, IValidatableObject
    {
        /// <summary>
        ...
        public ServiceEndpointVirtualIPs(string networkID = default, string addr = default)
        {
            NetworkID = networkID;
            Addr = addr;
        }
        ...
        {
            return Equals(input as ServiceEndpointVirtualIPs);
        }
