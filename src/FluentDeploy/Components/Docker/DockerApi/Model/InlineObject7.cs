...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class InlineObject7 : IEquatable<InlineObject7>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="InlineObject7" /> class.
        /// </summary>
        /// <param name="unlockKey">The swarm&#39;s unlock key..</param>
        public InlineObject7(string unlockKey = default)
        {
            UnlockKey = unlockKey;
        }
        ...
        {
            return Equals(input as InlineObject7);
        }
