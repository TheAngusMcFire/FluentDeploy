...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class TaskStatus : IEquatable<TaskStatus>, IValidatableObject
    {
        /// <summary>
        ...
        public TaskStatus(string timestamp = default, TaskState? state = default, string message = default,
            string err = default, TaskStatusContainerStatus containerStatus = default)
        {
            Timestamp = timestamp;
            State = state;
            Message = message;
        ...
        public bool Equals(TaskStatus input)
        {
            ...
            return
                ...
                (
                    Err == input.Err ||
                    Err != null &&
                    Err.Equals(input.Err)
                ) &&
                (
                    ContainerStatus == input.ContainerStatus ||
                    ContainerStatus != null &&
                    ContainerStatus.Equals(input.ContainerStatus)
                );
        }
        ...
        {
            return Equals(input as TaskStatus);
        }
