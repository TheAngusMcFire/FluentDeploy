...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class SwarmSpecOrchestration : IEquatable<SwarmSpecOrchestration>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="SwarmSpecOrchestration" /> class.
        /// </summary>
        /// <param name="taskHistoryRetentionLimit">
        ///     The number of historic tasks to keep per instance or node. If negative, never
        ///     remove completed or failed tasks. .
        /// </param>
        public SwarmSpecOrchestration(long taskHistoryRetentionLimit = default)
        {
        ...
        /// </summary>
        /// <param name="input">Instance of SwarmSpecOrchestration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwarmSpecOrchestration input)
        {
            if (input == null)
                return false;
            ...
            return
                ...
                TaskHistoryRetentionLimit.Equals(input.TaskHistoryRetentionLimit);
        }
        ...
        {
            return Equals(input as SwarmSpecOrchestration);
        }
