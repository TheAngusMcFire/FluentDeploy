...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class PortBinding : IEquatable<PortBinding>, IValidatableObject
    {
        /// <summary>
        ...
        public PortBinding(string hostIp = default, string hostPort = default)
        {
            HostIp = hostIp;
            HostPort = hostPort;
        }
        ...
        /// </summary>
        /// <param name="input">Instance of PortBinding to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortBinding input)
        {
            if (input == null)
                return false;
            ...
            return
                (
                    HostIp == input.HostIp ||
                    HostIp != null &&
                    HostIp.Equals(input.HostIp)
                ) &&
                (
                    HostPort == input.HostPort ||
                    HostPort != null &&
                    HostPort.Equals(input.HostPort)
                );
        }
        ...
        {
            return Equals(input as PortBinding);
        }
