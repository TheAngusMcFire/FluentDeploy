...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class MountVolumeOptions : IEquatable<MountVolumeOptions>, IValidatableObject
    {
        /// <summary>
        ...
        public MountVolumeOptions(bool noCopy = false, Dictionary<string, string> labels = default,
            MountVolumeOptionsDriverConfig driverConfig = default)
        {
        ...
        /// </summary>
        /// <param name="input">Instance of MountVolumeOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MountVolumeOptions input)
        {
            if (input == null)
                return false;
            ...
            return
                ...
                (
                    ...
                    DriverConfig != null &&
                    DriverConfig.Equals(input.DriverConfig)
                );
        }
        ...
        {
            return Equals(input as MountVolumeOptions);
        }
