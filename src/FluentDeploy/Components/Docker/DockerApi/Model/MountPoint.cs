...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class MountPoint : IEquatable<MountPoint>, IValidatableObject
    {
        /// <summary>
        ...
        public MountPoint(string type = default, string name = default, string source = default,
            string destination = default, string driver = default, string mode = default, bool rW = default,
        ...
        {
            return Equals(input as MountPoint);
        }
