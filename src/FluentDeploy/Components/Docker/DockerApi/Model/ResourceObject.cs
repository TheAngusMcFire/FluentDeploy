...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ResourceObject : IEquatable<ResourceObject>, IValidatableObject
    {
        /// <summary>
        ...
        /// </param>
        public ResourceObject(long nanoCPUs = default, long memoryBytes = default,
            List<object> genericResources = default)
        {
            NanoCPUs = nanoCPUs;
        ...
        /// </summary>
        /// <param name="input">Instance of ResourceObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceObject input)
        {
            if (input == null)
                return false;
            ...
            return
                ...
                (
                    ...
                    MemoryBytes != null &&
                    MemoryBytes.Equals(input.MemoryBytes)
                ) &&
                (
        ...
        {
            return Equals(input as ResourceObject);
        }
