...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ConfigSpec : IEquatable<ConfigSpec>, IValidatableObject
    {
        /// <summary>
        ...
        public ConfigSpec(string name = default, Dictionary<string, string> labels = default, string data = default,
            Driver templating = default)
        {
            Name = name;
            Labels = labels;
            Data = data;
        ...
        {
            return Equals(input as ConfigSpec);
        }
