...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    ///     ContainerSpec, NetworkAttachmentSpec, and PluginSpec are &gt; mutually exclusive. PluginSpec is only used when the
    ///     Runtime field &gt; is set to &#x60;plugin&#x60;. NetworkAttachmentSpec is used when the Runtime &gt; field is set
    ///     to &#x60;attachment&#x60;.
    /// </summary>
    [DataContract]
    public class TaskSpecPluginSpec : IEquatable<TaskSpecPluginSpec>, IValidatableObject
    {
        /// <summary>
        ...
        public TaskSpecPluginSpec(string name = default, string remote = default, bool disabled = default,
            List<InlineObject> pluginPrivilege = default)
        {
            Name = name;
            Remote = remote;
            Disabled = disabled;
        ...
        public List<InlineObject> PluginPrivilege { get; set; }
        ...
        public bool Equals(TaskSpecPluginSpec input)
        {
            ...
            return
                ...
                (
                    PluginPrivilege == input.PluginPrivilege ||
                    PluginPrivilege != null &&
                    input.PluginPrivilege != null &&
                    PluginPrivilege.SequenceEqual(input.PluginPrivilege)
                );
        }
        ...
        {
            return Equals(input as TaskSpecPluginSpec);
        }
