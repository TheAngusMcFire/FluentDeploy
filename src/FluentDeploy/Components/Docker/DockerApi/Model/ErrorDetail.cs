...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ErrorDetail : IEquatable<ErrorDetail>, IValidatableObject
    {
        /// <summary>
        ...
        public ErrorDetail(int code = default, string message = default)
        {
            Code = code;
            Message = message;
        }
        ...
        {
            return Equals(input as ErrorDetail);
        }
