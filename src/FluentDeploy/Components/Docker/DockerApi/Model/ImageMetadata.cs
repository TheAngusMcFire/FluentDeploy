...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ImageMetadata : IEquatable<ImageMetadata>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ImageMetadata" /> class.
        /// </summary>
        /// <param name="lastTagTime">lastTagTime.</param>
        public ImageMetadata(string lastTagTime = default)
        {
        ...
        public bool Equals(ImageMetadata input)
        {
            ...
            return
                LastTagTime == input.LastTagTime ||
                LastTagTime != null &&
                LastTagTime.Equals(input.LastTagTime);
        }
        ...
        {
            return Equals(input as ImageMetadata);
        }
