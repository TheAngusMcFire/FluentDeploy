...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class Secret : IEquatable<Secret>, IValidatableObject
    {
        /// <summary>
        ...
        public Secret(string iD = default, ObjectVersion version = default, string createdAt = default,
            string updatedAt = default, SecretSpec spec = default)
        {
            ID = iD;
            _Version = version;
            CreatedAt = createdAt;
