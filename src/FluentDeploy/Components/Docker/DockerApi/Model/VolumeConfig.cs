...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class VolumeConfig : IEquatable<VolumeConfig>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="VolumeConfig" /> class.
        /// </summary>
        ...
        public VolumeConfig(string name = default, string driver = "local",
            Dictionary<string, string> driverOpts = default, Dictionary<string, string> labels = default)
        {
            Name = name;
        ...
        /// <summary>
        ///     Returns true if VolumeConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of VolumeConfig to be compared</param>
        ...
        {
            return Equals(input as VolumeConfig);
        }
