...
namespace FluentDeploy.Components.Docker.DockerApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class InlineObject4 : IEquatable<InlineObject4>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineObject4(string container = default, bool force = default)
        {
            Container = container;
            Force = force;
        }
        ...
        {
            return Equals(input as InlineObject4);
        }
